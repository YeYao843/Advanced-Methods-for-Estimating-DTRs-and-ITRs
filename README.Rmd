...
#### <span style="color:grey;">Example</span>
In this repository, we give an example under continuous setting with correctly specified propensity model and no unmeasured confounders. The example code can be found: (https://github.com/YeYao843/DTR-Method-Summary/tree/main/M-learning/S1_Obs_cts.py)
...
The example code can be found: (https://github.com/YeYao843/DTR-Method-Summary/tree/main/CBR/example.R)
